...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  // {
  //   // Configure telemetry before creating the SwerveDrive
  ...
  //   }
  //   swerveDrive.setHeadingCorrection(false); // Enable if you want heading correction
  // }
  ...
  { 
    ...
    try
    {
      ...
      // CTRE Bus Optimizations for Pigeon
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("IMU Pitch", pitch);
    SmartDashboard.putNumber("IMU Roll", roll);
    SmartDashboard.putNumber("IMU Yaw Rate", yawRate);
    SmartDashboard.putNumber("Max Speed", swerveDrive.getMaximumChassisVelocity());
  ...
  public void setupPathPlanner()
  {
    ...
    // new PathPlannerAuto("Move 1 Meter Auto");
  }
